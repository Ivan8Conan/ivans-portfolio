      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={item.label} className="rounded-3xl border border-border bg-card p-6">
              <p className="text-[10px] uppercase tracking-[0.35em] text-muted-foreground">{item.label}</p>
        ...
        {d.metrics && d.metrics.length > 0 ? (
          <section className="rounded-3xl border border-border bg-card p-6">
            <SectionHeading index="01" title="Metrics" description={<>Numbers that define this project.</>} />
        ...
        <section className="rounded-3xl border border-border bg-card p-6">
          <SectionHeading index="06" title="Tech Stack" description={<>Tools and platforms used to build the solution.</>} />
                ...
                <Reveal key={c.title} delay={i * 40}>
                  <article className="rounded-3xl border border-border bg-card p-6">
                    ...
                    <div className="mt-6 rounded-2xl border border-border bg-background p-4">
                      <p className="text-[10px] uppercase tracking-[0.35em] text-muted-foreground">Outcome</p>
        ...
        {next && next.slug !== d.slug ? (
          <div className="mt-16 rounded-3xl border border-border bg-card p-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.35em] text-muted-foreground">Next case study</p>
